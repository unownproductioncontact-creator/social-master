...
/**
 * Panneau latéral (drawer) accessible, bâti sur le même socle Base UI Dialog
 * que src/components/ui/dialog.tsx : overlay, fermeture Échap/clic overlay et
 * gestion du focus sont héritées gratuitement du primitive Dialog.
 */
  ...
  return (
    <SheetPortal>
      ...
      <DialogPrimitive.Popup
        ...
        className={cn(
          "fixed inset-y-0 z-50 flex h-full w-full max-w-xs flex-col gap-4 bg-popover text-sm text-popover-foreground shadow-lg ring-1 ring-foreground/10 outline-none duration-150",
          side === "left" &&
